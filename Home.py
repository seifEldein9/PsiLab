...
class Home():
    def Home(home):
        ...
        def math():
            ...
            bx23.pack(fill=X)
        #=======================================================
        Home = Frame(home,bg='#f8f8ff',width='1100',height='650')
        ...
        functionsset2.place(x=250,y=100,height=50,width=850)
        ...
        mainframe = Frame(Home , bg="#3F61B0",height=50,width=1350)
        mainframe.place(x=0,y=0)
        mainframe.pack_propagate(False)
        l2f = Label(mainframe,text='Home', bg="#3F61B0",fg='#E9F8F9',font=('Bold',20))
        l2f.pack(side=LEFT)
        wfd1 = Frame(Home , bg="#DFDFE6",height=650,width=250)
        wfd1.place(x=0,y=50)
